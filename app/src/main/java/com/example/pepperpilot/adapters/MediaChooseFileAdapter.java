...
public class MediaChooseFileAdapter extends RecyclerView.Adapter<MediaChooseFileAdapter.MyViewHolder> {
    ...
    public MediaChooseFileAdapter(List<Media> filesList, Context context, MediaCallback mediaCallback) {
    ...
    public MediaChooseFileAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.multimedia_list_item, parent, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(final MediaChooseFileAdapter.MyViewHolder holder, int position) {
